...
<MenuBar
  ...
  optionIds
  options={[
    { icon: boldIcon, id: "bold", tooltip: "Bold", onClick: () => (active = active === "bold" ? undefined : "bold") },
    { icon: italicIcon, id: "italic", tooltip: "Italic", onClick: () => (active = active === "italic" ? undefined : "italic") },
  ]}
/>
